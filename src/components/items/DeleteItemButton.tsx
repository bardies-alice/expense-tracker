...
export function DeleteItemButton({ id, categoryId }: { id: string; categoryId: string }) {
  ...
  return (
    <button
      ...
      disabled={pending}
      className="absolute right-1 top-1 flex h-10 w-10 items-center justify-center rounded-full text-gray-300 hover:bg-red-50 hover:text-red-500 disabled:opacity-50"
